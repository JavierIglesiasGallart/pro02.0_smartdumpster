...
class SimpleController(Node):
    def __init__(self):
        ...
        self.declare_parameter("wheel_separation", 0.796)
        ...
        self.odom_pub_ = self.create_publisher(Odometry, "smartdumpster_controller/odom", 10)
        #Subscriber
        self.vel_sub_ = self.create_subscription(TwistStamped, "smartdumpster_controller/cmd_vel", self.velCallback, 10)
    ...
    def jointCallback(self, msg):
        ...
        fi_rigth = dp_right / (dt.nanoseconds / S_TO_NS)

        linear = (self.wheel_radius_ * fi_rigth + self.wheel_radius_ * fi_left) / 2
        angular = (self.wheel_radius_ * fi_rigth - self.wheel_radius_ * fi_left) / self.wheel_separation_
