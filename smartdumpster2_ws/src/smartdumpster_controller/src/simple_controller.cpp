#include "smartdumpster_controller/simple_controller.hpp"
...
SimpleController::SimpleController(const std::string & name)
    ...
    , theta_(0.0)
{
    declare_parameter("wheel_radius", 0.0975);
    declare_parameter("wheel_separation", 0.796);
    ...
    odom_pub_ = create_publisher<nav_msgs::msg::Odometry>("/smartdumpster_controller/odom", 10);
    // Subscription
    vel_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>("/smartdumpster_controller/cmd_vel", 10, 
